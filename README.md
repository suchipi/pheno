...
- Lightweight: The whole library is 10.5K minified (before gzip/brotli), but it's also fully tree-shakeable, so only the type validators you use end up in your bundle.
